...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Visited: "+str(cont_v))
            print("Extended: "+str(cont_e))
            return node
...
def branch_and_bound_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, SortedStack())

def branch_and_bound_subestimate_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, SortedStack2(problem))
